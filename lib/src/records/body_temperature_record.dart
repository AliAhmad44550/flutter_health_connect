...
class BodyTemperatureRecord extends InstantaneousRecord {
  ...
  BodyTemperatureRecord({
    ...
    metadata,
  })  : assert(temperature.inCelsius >= _minTemperature.inCelsius && temperature.inCelsius <= _maxTemperature.inCelsius),
        metadata = metadata ?? Metadata.empty();

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is BodyTemperatureRecord && time == other.time && zoneOffset == other.zoneOffset && temperature == other.temperature;

  @override
  int get hashCode => time.hashCode ^ zoneOffset.hashCode ^ temperature.hashCode;
