...
class LeanBodyMassRecord extends InstantaneousRecord {
  ...
  LeanBodyMassRecord({required this.time, this.zoneOffset, required this.mass, metadata})
      : metadata = metadata ?? Metadata.empty(),
        assert(mass.inKilograms >= _minMass.inKilograms && mass.inKilograms <= _maxMass.inKilograms);
  ...
  @override
  int get hashCode => metadata.hashCode ^ time.hashCode ^ zoneOffset.hashCode ^ mass.hashCode;
