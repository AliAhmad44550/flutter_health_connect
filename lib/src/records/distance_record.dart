...
class DistanceRecord extends IntervalRecord {
  /// Unit: meters
  static const String aggregationKeyDistanceTotal = 'DistanceRecordDistanceTotal';
  ...
  DistanceRecord({
    ...
    required this.distance,
        ...
        assert(distance.inMeters >= _minDistance.inMeters && distance.inMeters <= _maxDistance.inMeters);
  ...
  @override
  int get hashCode =>
      endTime.hashCode ^ endZoneOffset.hashCode ^ metadata.hashCode ^ startTime.hashCode ^ startZoneOffset.hashCode ^ distance.hashCode;
